# Riot-API
This is a project made to offer the front-end of Yasin's a fully working backend making calls to the api and returning corresponding to the replies java object instances (wrapped json in java classes)

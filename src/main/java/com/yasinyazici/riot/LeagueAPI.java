...
public class LeagueAPI {
    ...
    public synchronized String getLatestGameVersion(Region region) throws DataException, WrongRequestFormatException, ReplyException, IOException {
        return new GameVersionParser(RequestCreator.createRequest(new RequestProperty(GlobalRequestType.GET_GAME_VERSIONS, region.getShortCode()))).get()[0];
    }
    ...
    public synchronized Map<String, Runes> getRunes(Region region, long ... summonerId) throws DataException, WrongRequestFormatException, ReplyException, IOException {
